...
A:hover { COLOR: #36454F; TEXT-DECORATION: none; font-weight: bold }
</style>


<script>
    const example = document.getElementsByClassName("targetText");

example.addEventListener('mouseover',  handleMouseOver);
...
example.addEventListener('mouseout',  handleMouseOut);
